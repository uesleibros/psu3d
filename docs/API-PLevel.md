...
**Devolve.** True when the document held a usable level.
...
**Devolve.** True when the file was found and held a usable level.
...
**Devolve.** The message, or an empty string when it succeeded.
...
**Devolve.** The budget floor, or zero when the level did not say.
...
**Devolve.** The budget ceiling, or zero when the level did not say.
...
**Devolve.** The value, or zero when the level did not say.
...
**Devolve.** The height; meaningful only when HasKillZ is True.
...
**Devolve.** True when the file was written.
